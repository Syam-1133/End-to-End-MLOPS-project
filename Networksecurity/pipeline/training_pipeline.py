...
class TrainingPipline:
    ...
    def run_pipeline(self):
        try:
            ...
            data_trasformattion_artifact = self.start_data_transformation(data_validation_artifact=data_validation_artifact)
            model_trainer_artifact = self.start_model_trainer(data_transformation_artifact=data_trasformattion_artifact)
